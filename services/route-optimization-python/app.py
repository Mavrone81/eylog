...
def solve_tsp(locations):
    ...
    algorithms.eaSimple(population, toolbox, cxpb=0.7, mutpb=0.2, ngen=50, stats=stats, halloffame=hall_of_fame, verbose=False)

    best_route_indices = hall_of_fame[0]
    optimized_locations = [locations[i] for i in best_route_indices]
    total_distance = calculate_total_distance(best_route_indices, locations)[0]
