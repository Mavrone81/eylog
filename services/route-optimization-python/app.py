...
def calculate_total_distance(individual, locations):
    ...
    # Return to start? For TSP we usually do.
    # But for delivery, maybe just stop at last location.
    # Let's assume a cycle for standard TSP.
...
def solve_tsp(locations):
    ...
    # DEAP types definition with check to prevent re-definition
